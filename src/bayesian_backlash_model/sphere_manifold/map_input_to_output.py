...
if __name__ == "__main__" :
    ...
    #%%    
    # Experiment : Sample points on the workspace and compute the 
    #              angular velocity jacobian w.r.t the cable actuation in ee frame
    #              Compute the mean and std of the jacobians
    ...
    #     for j in range(nb_samples):
    #         ang_vel_jacobians_wrt_cables[:,:,i*nb_samples + j] = \
    #             model.jacobian_angular_ee(np.array([q_var_q1[j], q_var_q2[i]]))
    ...
    """
    Mean = 
    [[ 2.22826202e-17  1.61106081e+02]
    [-1.61106081e+02  9.54969437e-18]
    [-1.09866960e-15  1.78806658e-15]]

    std =
    [[ 5.51519511  4.93453678]
    [ 4.93453678  5.51519511]
    [36.05531133 36.05531133]]
    """   
    ...
    labels = ['ang vel', 'lin vel']
    ax.legend(lines, labels)
    ax.set_title("Angular velocity vector field old version")
    ...
    labels = ['ang vel', 'lin vel']
    ax.legend(lines, labels)
    ax.set_title("Angular velocity vector field in the end effector frame")
